...
Pour l'utiliser, on a les méthode
    new nomDeLaClass(id) : charge directement un objet
    ...
    Méthodes pouvant être crées dans les classes filles pour gérer des cas particuliers
    (méthodes protégées)
    get_xxx() : cette méthode permet de faire un traitement spécifique si on essaie de récupérer le champ xxx

    verify() : cette méthode véifie si l'objet est "cohérent"
*/
...
class _model {
    ...
    function advancedLoad($param) {
        // Rôle : charge l'objet courant
        // Paramètre :
        //      $param : soit un id : on récupère alors l'objet dans la BDD avec cet id
        //               soit un tableau : on charge alors les valeurs avec les infos dans ce tablea
        //               soit un autre objet issu de _model : copie ses valeurs

        // Si le paramètre est un id :
    ...
    function verify() {
        // Role : indique si les valeurs sont cohérentes ou pas
        // Parametres : néant
        // Retour : true si ok, false sinon
